...
const Student = () => {
  ...
  const handleExportToExcel = async () => {
    try {
      ...
      XLSX.utils.book_append_sheet(wb, ws, 'participantesInalta');
      XLSX.writeFile(wb, 'participantesInalta.xlsx');
  ...
  return (
    <section className="p-2">
      ...
      <div className="text-center text-gray-900 dark:text-blue-100  lg:p-6 p-0 lg:text-2xl text-xl font-extrabold">
